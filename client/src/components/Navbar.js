    ...
    <div>
        <nav>
            <div className="navWrapper">
                ...
                {page === "Signup" ? (<li className="nav-item active"><a className="nav-link">Signup</a></li>) : (<li className="nav-item"><a className="nav-link" onClick={ () => {handleClick("AllLists")}}>Signup</a></li>)}
